...
public class CssGroupRuleBodyImpl extends ASTWrapperPsiElement implements CssGroupRuleBody {

  public CssGroupRuleBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitGroupRuleBody(this);
  }
