...
public class CssFontFaceRuleImpl extends ASTWrapperPsiElement implements CssFontFaceRule {

  public CssFontFaceRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitFontFaceRule(this);
  }
  ...
  @Override
  @NotNull
  public List<CssFontFaceDeclaration> getFontFaceDeclarationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CssFontFaceDeclaration.class);
  }
