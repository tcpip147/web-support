...
public class CssImportsImpl extends ASTWrapperPsiElement implements CssImports {

  public CssImportsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public CssMediaQueryList getMediaQueryList() {
    return findChildByClass(CssMediaQueryList.class);
  }
