...
public class CssMediaQueryListImpl extends ASTWrapperPsiElement implements CssMediaQueryList {

  public CssMediaQueryListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CssMediaQuery> getMediaQueryList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CssMediaQuery.class);
  }
