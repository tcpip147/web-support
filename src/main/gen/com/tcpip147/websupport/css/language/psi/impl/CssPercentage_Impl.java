...
public class CssPercentage_Impl extends ASTWrapperPsiElement implements CssPercentage_ {

  public CssPercentage_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitPercentage_(this);
  }
