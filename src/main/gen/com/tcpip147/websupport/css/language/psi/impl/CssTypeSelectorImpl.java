...
public class CssTypeSelectorImpl extends ASTWrapperPsiElement implements CssTypeSelector {

  public CssTypeSelectorImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public CssElementName getElementName() {
    return findNotNullChildByClass(CssElementName.class);
  }
