...
public class CssSelectorGroupImpl extends ASTWrapperPsiElement implements CssSelectorGroup {

  public CssSelectorGroupImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitSelectorGroup(this);
  }
