...
public class CssCounterStyle_Impl extends ASTWrapperPsiElement implements CssCounterStyle_ {

  public CssCounterStyle_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitCounterStyle_(this);
  }
