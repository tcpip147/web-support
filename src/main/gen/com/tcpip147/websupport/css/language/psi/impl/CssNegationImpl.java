...
public class CssNegationImpl extends ASTWrapperPsiElement implements CssNegation {

  public CssNegationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public CssNegationArg getNegationArg() {
    return findNotNullChildByClass(CssNegationArg.class);
  }
