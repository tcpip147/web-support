...
public class CssKeyframesRuleImpl extends ASTWrapperPsiElement implements CssKeyframesRule {

  public CssKeyframesRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitKeyframesRule(this);
  }
  ...
  @Override
  @NotNull
  public List<CssKeyframeBlock> getKeyframeBlockList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CssKeyframeBlock.class);
  }
