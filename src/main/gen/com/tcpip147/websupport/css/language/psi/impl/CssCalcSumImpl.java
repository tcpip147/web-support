...
public class CssCalcSumImpl extends ASTWrapperPsiElement implements CssCalcSum {

  public CssCalcSumImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitCalcSum(this);
  }
  ...
  @Override
  @NotNull
  public List<CssCalcProduct> getCalcProductList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CssCalcProduct.class);
  }
