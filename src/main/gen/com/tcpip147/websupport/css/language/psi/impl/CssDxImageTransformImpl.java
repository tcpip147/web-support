...
public class CssDxImageTransformImpl extends ASTWrapperPsiElement implements CssDxImageTransform {

  public CssDxImageTransformImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitDxImageTransform(this);
  }
