...
public class CssOperator_Impl extends ASTWrapperPsiElement implements CssOperator_ {

  public CssOperator_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitOperator_(this);
  }
