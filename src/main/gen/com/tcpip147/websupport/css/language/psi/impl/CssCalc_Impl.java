...
public class CssCalc_Impl extends ASTWrapperPsiElement implements CssCalc_ {

  public CssCalc_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitCalc_(this);
  }
  ...
  public CssCalcSum getCalcSum() {
    return findNotNullChildByClass(CssCalcSum.class);
  }
