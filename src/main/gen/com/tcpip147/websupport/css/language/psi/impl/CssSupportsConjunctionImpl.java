...
public class CssSupportsConjunctionImpl extends ASTWrapperPsiElement implements CssSupportsConjunction {

  public CssSupportsConjunctionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitSupportsConjunction(this);
  }
