...
public class CssFunctionalPseudoImpl extends ASTWrapperPsiElement implements CssFunctionalPseudo {

  public CssFunctionalPseudoImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitFunctionalPseudo(this);
  }
  ...
  public CssExpression getExpression() {
    return findNotNullChildByClass(CssExpression.class);
  }
