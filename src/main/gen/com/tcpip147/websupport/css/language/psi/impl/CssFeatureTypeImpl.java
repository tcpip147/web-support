...
public class CssFeatureTypeImpl extends ASTWrapperPsiElement implements CssFeatureType {

  public CssFeatureTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitFeatureType(this);
  }
