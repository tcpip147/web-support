...
public class CssUnknownDimensionImpl extends ASTWrapperPsiElement implements CssUnknownDimension {

  public CssUnknownDimensionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitUnknownDimension(this);
  }
