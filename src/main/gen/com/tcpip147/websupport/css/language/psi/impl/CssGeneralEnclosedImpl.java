...
public class CssGeneralEnclosedImpl extends ASTWrapperPsiElement implements CssGeneralEnclosed {

  public CssGeneralEnclosedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitGeneralEnclosed(this);
  }
