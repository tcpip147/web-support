...
public class CssUnknownDimension_Impl extends ASTWrapperPsiElement implements CssUnknownDimension_ {

  public CssUnknownDimension_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitUnknownDimension_(this);
  }
