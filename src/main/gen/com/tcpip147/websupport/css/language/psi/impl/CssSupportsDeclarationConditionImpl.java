...
public class CssSupportsDeclarationConditionImpl extends ASTWrapperPsiElement implements CssSupportsDeclarationCondition {

  public CssSupportsDeclarationConditionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitSupportsDeclarationCondition(this);
  }
  ...
  public CssDeclaration getDeclaration() {
    return findNotNullChildByClass(CssDeclaration.class);
  }
