...
public class CssFontFamilyNameListImpl extends ASTWrapperPsiElement implements CssFontFamilyNameList {

  public CssFontFamilyNameListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitFontFamilyNameList(this);
  }
  ...
  @Override
  @NotNull
  public List<CssFontFamilyName> getFontFamilyNameList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CssFontFamilyName.class);
  }
