...
public class CssDimension_Impl extends ASTWrapperPsiElement implements CssDimension_ {

  public CssDimension_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitDimension_(this);
  }
