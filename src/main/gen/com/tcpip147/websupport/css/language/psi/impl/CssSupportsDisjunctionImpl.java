...
public class CssSupportsDisjunctionImpl extends ASTWrapperPsiElement implements CssSupportsDisjunction {

  public CssSupportsDisjunctionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitSupportsDisjunction(this);
  }
  ...
  @Override
  @NotNull
  public List<CssSupportsConditionInParens> getSupportsConditionInParensList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CssSupportsConditionInParens.class);
  }
