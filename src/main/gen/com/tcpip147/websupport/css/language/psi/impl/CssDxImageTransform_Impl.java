...
public class CssDxImageTransform_Impl extends ASTWrapperPsiElement implements CssDxImageTransform_ {

  public CssDxImageTransform_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitDxImageTransform_(this);
  }
