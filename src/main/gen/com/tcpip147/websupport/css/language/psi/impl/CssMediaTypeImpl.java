...
public class CssMediaTypeImpl extends ASTWrapperPsiElement implements CssMediaType {

  public CssMediaTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitMediaType(this);
  }
