...
public class CssTypeNamespacePrefixImpl extends ASTWrapperPsiElement implements CssTypeNamespacePrefix {

  public CssTypeNamespacePrefixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitTypeNamespacePrefix(this);
  }
