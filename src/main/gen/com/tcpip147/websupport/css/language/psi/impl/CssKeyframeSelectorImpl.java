...
public class CssKeyframeSelectorImpl extends ASTWrapperPsiElement implements CssKeyframeSelector {

  public CssKeyframeSelectorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitKeyframeSelector(this);
  }
