...
public class CssViewport_Impl extends ASTWrapperPsiElement implements CssViewport_ {

  public CssViewport_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitViewport_(this);
  }
