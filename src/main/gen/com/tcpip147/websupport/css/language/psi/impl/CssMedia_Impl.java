...
public class CssMedia_Impl extends ASTWrapperPsiElement implements CssMedia_ {

  public CssMedia_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitMedia_(this);
  }
  ...
  @Override
  @NotNull
  public CssMediaQueryList getMediaQueryList() {
    return findNotNullChildByClass(CssMediaQueryList.class);
  }
