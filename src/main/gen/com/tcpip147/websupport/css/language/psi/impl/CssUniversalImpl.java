...
public class CssUniversalImpl extends ASTWrapperPsiElement implements CssUniversal {

  public CssUniversalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitUniversal(this);
  }
