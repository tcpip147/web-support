...
public class CssMediaExpressionImpl extends ASTWrapperPsiElement implements CssMediaExpression {

  public CssMediaExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitMediaExpression(this);
  }
  ...
  public CssMediaFeature getMediaFeature() {
    return findNotNullChildByClass(CssMediaFeature.class);
  }
