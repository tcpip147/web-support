...
public class CssCounterStyleImpl extends ASTWrapperPsiElement implements CssCounterStyle {

  public CssCounterStyleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitCounterStyle(this);
  }
