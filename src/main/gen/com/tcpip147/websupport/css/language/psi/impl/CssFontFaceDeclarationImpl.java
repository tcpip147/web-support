...
public class CssFontFaceDeclarationImpl extends ASTWrapperPsiElement implements CssFontFaceDeclaration {

  public CssFontFaceDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CssVisitor visitor) {
    visitor.visitFontFaceDeclaration(this);
  }
